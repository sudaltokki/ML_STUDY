...
'''
면적 그래프 - 구현된 선 그래프와 x축 사이의 공간에 색이 입혀진다
색의 투명도(alpha)는 기본값 0.5(범위 0~1)
선을 그리는 plot() 메소드에 kind='area'옵션을 추가
그래프 누적여부는 stacked 옵션으로 결정, 기본값은 stacked=True >> 누적 선 그래프
'''
